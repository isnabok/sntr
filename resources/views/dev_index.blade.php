                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                <li>Call Us: <strong class="text-brand"> + 1800 900</strong></li>
                                <li>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="#"><img src="{{ asset('img/ico/logo.svg') }}" alt="logo" /></a>
                    </div>
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="#">
                                        <img class="svgInject" alt="" src="{{ asset('img/ico/icon-compare.svg') }}" />
                                ...
                                <div class="header-action-icon-2">
                                    <a href="#">
                                        <img class="svgInject" alt="" src="{{ asset('img/ico/icon-heart.svg') }}" />
                                ...
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="#">
                                        <img alt="" src="{{ asset('img/ico/icon-cart.svg') }}" />
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="" src="{{ asset('img/site/thumbnail-3.jpg') }}"/></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="Nest" src="{{ asset('img/site/thumbnail-3.jpg') }}" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="#">
                                        <img class="svgInject" alt="" src="{{ asset('img/ico/icon-user.svg') }}" />
                                    </a>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            <a class="categories-button-active" href="#">
                                <span class="fi-rs-apps"></span> <span class="et">По</span> Странам
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="#"> <img src="{{ asset('img/ico/category-1.svg') }}" alt="" />Milks and Dairies</a>
                                        </li>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href="#"> <img src="{{ asset('img/ico/category-1.svg') }}" alt="" />Wines & Drinks</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="{{ asset('img/ico/icon-hot.svg') }}" alt="hot deals" /><a href="#">Акции!</a></li>
                                    <li>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="#"><img src="{{ asset('img/banner/banner-menu.png') }}" alt="Nest" /></a>
                    ...
                    <div class="hotline d-none d-lg-flex">
                        <img src="{{ asset('img/ico/icon-headphone.svg') }}" alt="hotline" />
                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.html">
                                    <img alt="Nest" src="{{ asset('img/ico/icon-heart.svg') }}" />
                                    <span class="pro-count white">4</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="#">
                                    <img alt="Nest" src="{{ asset('img/ico/icon-cart.svg') }}" />
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon mb-50">
                    ...
                    <a href="#"><img src="{{ asset('img/ico/icon-facebook-white.svg') }}" alt="" /></a>
                    <a href="#"><img src="{{ asset('img/ico/icon-twitter-white.svg') }}" alt="" /></a>
                    <a href="#"><img src="{{ asset('img/ico/icon-instagram-white.svg') }}" alt="" /></a>
                    <a href="#"><img src="{{ asset('img/ico/icon-pinterest-white.svg') }}" alt="" /></a>
                    <a href="#"><img src="{{ asset('img/ico/icon-youtube-white.svg') }}" alt="" /></a>
                </div>
                    ...
                    <div class="col-xl-8 col-lg-12">
                        <div class="home-slide-cover">
                            <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                                <div class="single-hero-slider single-animation-wrap" style="background-image: url({{ asset('img/banner/slider-3.png') }})">
                                    <div class="slider-content">
                                        <h1 class="display-2 mb-40">
                                            Пейте кофе<br />
                                            Большая скидка
                                        </h1>
                                        <p class="mb-65">Вы экономите 50% off on your first order</p>
                                ...
                                <div class="single-hero-slider single-animation-wrap" style="background-image: url({{ asset('img/banner/slider-4.png') }})">
                                    <div class="slider-content">
                                        <h1 class="display-2 mb-40">
                                            Snacks box<br />
                                            daily save
